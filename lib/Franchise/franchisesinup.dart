...
class FranchiseSinup extends StatefulWidget {
  @override
  State<FranchiseSinup> createState() => _FranchiseSinupState();
}

class _FranchiseSinupState extends State<FranchiseSinup> {
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Card(
                  elevation: 5,
                  color: Color.fromARGB(255, 235, 34, 34).withOpacity(0.4),
                  child: Container(
                    width: 400,
