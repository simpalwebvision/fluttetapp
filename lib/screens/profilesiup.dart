...
class Profilesiup extends StatefulWidget {
  @override
  State<Profilesiup> createState() => _ProfilesiupState();
}

class _ProfilesiupState extends State<Profilesiup> {
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Card(
                  elevation: 5,
                  color: Color.fromARGB(255, 252, 29, 41).withOpacity(0.4),
                  child: Container(
                    width: 400,
