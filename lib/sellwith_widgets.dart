...
class SellWithWidgets extends StatefulWidget {
  const SellWithWidgets({super.key});

  @override
  State<SellWithWidgets> createState() => _SellWithWidgetsState();
}

class _SellWithWidgetsState extends State<SellWithWidgets> {
  List imageList = [
    {"id": 2, "image_path": 'assets/images/desing.jpg'},
  ];
    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
          ...
          Container(
            ...
            height: 170, //parent size
            child: LayoutBuilder(builder: (context, size) {
              return Row(
                children: [
                  Container(
                    child: Image.asset(
                      'assets/images/grop.jpg',
                      scale: 1,
                    ),
                  ),
                  SizedBox(
                    ...
                    child: Column(children: [
                      Expanded(
                        child: Container(
                          ...
                          "Shop our limited Edition Collaborations 2003 World Habitat Day Children’s Drawing Contest Asian-Pacific Children’s Convention Award Ms. Nafisa Tabassum (4th Grade, Mohana Art School, Bangladesh Children’s Convention Award Ms. Nafisa Tabassum Children’s Convention Award Ms. Nafisa Tabassum)",
          ...
          MaterialButton(
            ...
            onPressed: () {
              Navigator.push(
                  context, MaterialPageRoute(builder: (context) => AboutArt()));
            },
            child: Text(
              'Contact Us',
              style: TextStyle(color: Colors.white),
